    ...
    elements.forEach(el => {
        ...
        if (el.tagName === 'A') {
            ...
            if (match) {
                ...
                if (videoId) {
                    el.outerHTML = `<div class=\"yt-video-embed\" style=\"margin:10px 0;\"><div style=\"position:relative;width:100%;padding-bottom:56.25%;height:0;\"><iframe style=\"position:absolute;top:0;left:0;width:100%;height:100%;border-radius:8px;\" src=\"https://www.youtube.com/embed/${videoId}\" frameborder=\"0\" allowfullscreen></iframe></div></div>`;
                }
            }
        } else {
            ...
            let newHtml = html.replace(ytRegex, function(match, url1, id1, id2) {
                ...
                if (videoId) {
                    return `<div class=\"yt-video-embed\" style=\"margin:10px 0;\"><div style=\"position:relative;width:100%;padding-bottom:56.25%;height:0;\"><iframe style=\"position:absolute;top:0;left:0;width:100%;height:100%;border-radius:8px;\" src=\"https://www.youtube.com/embed/${videoId}\" frameborder=\"0\" allowfullscreen></iframe></div></div>`;
                }
                return match;
            });
            if (newHtml !== html) {
